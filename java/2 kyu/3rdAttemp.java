...
public class MorseCodeDecoder {
    ...
    public static String decodeBitsAdvanced(String bits) {
        ...
        Integer cluster1Max = cluster1.stream().mapToInt(val -> val).max().orElse(0);
        Integer cluster3Min = cluster3.stream().mapToInt(val -> val).min().orElse(0);
        ...
        System.out.println("cluster1Max :" + cluster1Max);
        System.out.println("cluster3Min :" + cluster3Min);
